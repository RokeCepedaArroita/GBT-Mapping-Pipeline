...
# Config
name = 'kuminimisation'
filelist = 'TOD_BandKu_firstKu_filelist_FULL'
reference_config = './destriper_configs/default_Ku.ini'
...
plt.figure(1,figsize=(7.8,2.5))
plt.plot(baseline_lengths,MAD_mK)
plt.title('Destriping Length Optimisation: Ku-band')
plt.ylabel('Pixel Scale M.A.D (mK)')
plt.xlabel('Destriping Baseline (samples)')
