...
if frequency == 4.85:
    zoom = 0.97 # arbitrary zoom factor for figure
elif frequency == 13.7:
...
# Plot map
plot_map_thesis(image=image, nhits=nhits, rms=rms, wcs=w, zoom=zoom, title=sim_map[:-5], contourdata=contour_array, dark_clouds=molecular_clouds, central_coords=central_coords, frequency=frequency)
plt.show()
